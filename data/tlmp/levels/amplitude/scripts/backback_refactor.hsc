...
(script static object_definition (get_weapon (short INDEX))
	...
	(if (= INDEX 2) (set return_object_definition "tlmp\weapons\plasma pistol\plasma pistol"))
	(if (= INDEX 3) (set return_object_definition "tlmp\weapons\needler\needler"))
	(if (= INDEX 4) (set return_object_definition "weapons\pistol\pistol"))
	(if (= INDEX 5) (set return_object_definition "tlmp\weapons\plasma rifle\plasma rifle"))
	(if (= INDEX 6) (set return_object_definition "tlmp\weapons\assault rifle\assault rifle"))
	(if (= INDEX 7) (set return_object_definition "weapons\shotgun\shotgun"))
	(if (= INDEX 8) (set return_object_definition "weapons\flamethrower\flamethrower"))
	(if (= INDEX 9) (set return_object_definition "weapons\sniper rifle\sniper rifle"))
	(if (= INDEX 10) (set return_object_definition "weapons\rocket launcher\rocket launcher"))
	(if (= INDEX 11) (set return_object_definition "tlmp\weapons\fuel rod gun\fuel rod gun"))
...
(script static string (get_permutation (short INDEX))
	...
	(if (= INDEX 2) (set return_string "plasma_pistol"))
	(if (= INDEX 3) (set return_string "needler"))
	(if (= INDEX 4) (set return_string "pistol"))
	(if (= INDEX 5) (set return_string "plasma_rifle"))
	(if (= INDEX 6) (set return_string "assault_rifle"))
	(if (= INDEX 7) (set return_string "shotgun"))
	(if (= INDEX 8) (set return_string "flamethrower"))
	(if (= INDEX 9) (set return_string "sniper_rifle"))
	(if (= INDEX 10) (set return_string "rocket_launcher"))
	(if (= INDEX 11) (set return_string "plasma_cannon"))
	return_string
)
