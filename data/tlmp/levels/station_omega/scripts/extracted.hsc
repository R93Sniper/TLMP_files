...
(script continuous "panic doors control"
    (if
        (= (device_get_position panic_control) 1.000000)
        (begin
            (object_create_anew panic_door)
            (device_set_power panic_door 1.000000)
            (device_set_position panic_door 1.000000)
            (sleep_until
                (= (device_get_position panic_control) 0.000000)
            )
        )
        (begin
            (device_set_power panic_door 0.000000)
            (device_set_position panic_door 0.000000)
            (sleep 10)
            (object_destroy panic_door)
        )
    )
)


(script startup "panic control online" (device_set_power panic_control 1.000000))
